 ...
 */
final class Version20240222161919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE statut_coursier (id INT AUTO_INCREMENT NOT NULL, relation_id INT DEFAULT NULL, region VARCHAR(255) NOT NULL, debut_tourner DATETIME DEFAULT NULL, fin_tourner DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_794EA76E3256915B (relation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
